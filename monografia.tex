...
\begin{itemize}
\item Pro Quinctio
\item Pro Roscio Amerino
\item Pro Q. Roscio Comoedo
...
\subsection{Discursos políticos}
\begin{itemize}
\item Pro Lege Manilia (De Imperio Pompei)
...
\subsection{Retórica e política}
\begin{itemize}
\item De Inventione
\item De Oratore
...
\section{Coleta}
\par Agregação do material para montagem dos \textit{corpora}, pensando já na relevância dos textos, utilidade deles e abrangência linguística. Será preciso orientação próxima para que o material coletado seja relevante e representativo. Tempo estimado: Out-Nov 2011. Complexidade: média.
