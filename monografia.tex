...
\item De Inventione
\item De Oratore
\item De Partitionibus Oratoriae (De Partitione Oratoria)
...
\par Para o latim será criado, sob orientação, um catálogo geral de \textit{stopwords} (no modelo clássico, uma lista finita de termos), e catálogos menores onde se encontrará somente preposições, ou somente pronomes e assim por diante, para que os alunos e pesquisadores possam refinar melhor o uso de \textit{stopwords} em latim.
