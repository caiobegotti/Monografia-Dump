...
\item Pro Gaio Antonio\footnote{Aparentemente um texto perdido, ou jamais escrito por Cícero apesar de existirem referências a ele.} 
...
\item De Re Publica
\item De Temporibus Suis\footnote{Documento aparentemente perdido, mas atribuído a Cícero.} 
...
\begin{itemize}
\item Academica Priora\footnote{Também citado como Catulus, aparentemente um texto perdido.} 
